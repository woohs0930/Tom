    ...
    <div class="container content">
        <div class="row">
            <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                <form class="reg-page" name="joinForm">
                    ...
                    <div class="row">   	
	                        ...
	                        <div class="col-sm-4">                      	      
	                            <input type="text" name="email2" class="form-control margin-bottom-20" readonly="readonly">
	                        </div>               	                       
                    </div>
                    ...
                    <div class="row">   	
                        <div class="col-sm-12" align="center">
	                        <input type="checkbox" value="1">가요&nbsp;&nbsp;&nbsp;
							<input type="checkbox" value="2">POP&nbsp;&nbsp;&nbsp;
							<input type="checkbox" value="3">OST&nbsp;&nbsp;&nbsp;
							<input type="checkbox" value="4">일렉트로니카&클럽뮤직&nbsp;&nbsp;
							<input type="checkbox" value="5">록/메탈&nbsp;&nbsp;&nbsp;
							<input type="checkbox" value="6">R&B/Soul&nbsp;&nbsp;&nbsp;<br>
							<input type="checkbox" value="7">랩/힙합&nbsp;&nbsp;&nbsp;
							<input type="checkbox" value="8">인디음악&nbsp;&nbsp;&nbsp;
							<input type="checkbox" value="9">트로트&nbsp;&nbsp;&nbsp;
							<input type="checkbox" value="10">J-POP&nbsp;&nbsp;&nbsp;
							<input type="checkbox" value="11">클래식&nbsp;&nbsp;&nbsp;
							<input type="checkbox" value="12">재즈&nbsp;&nbsp;&nbsp;		
                        </div>                                                  	                        
                    </div>
                    <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 text-right">
                            <button class="btn-u" type="button" onclick="">Register</button>
